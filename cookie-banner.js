...
(function () {
  ...
  function createBanner() {
    var bannerHTML = ''
      ...
      + '      Optionale Cookies (z.B. Analyse, Marketing oder eingebettete Medien) werden ausschließlich nach Ihrer ausdrücklichen Einwilligung gesetzt. '
      + '      Sie können Ihre Einwilligung jederzeit über den Link „Cookies" im Footer widerrufen oder anpassen. '
      ...
      + '          <div class="cookie-cat-desc">Helfen uns zu verstehen, wie Besucher die Website nutzen. Daten werden anonymisiert erhoben und erst nach Ihrer Einwilligung gesetzt.</div>'
      + '        </div>'
      + '      </label>'
      + '      <label class="cookie-category">'
      ...
      + '          <div class="cookie-cat-desc">Werden für personalisierte Werbeinhalte und externe Medien (z.B. eingebettete Videos) verwendet. Werden erst nach Ihrer Einwilligung aktiviert.</div>'
      + '        </div>'
      + '      </label>'
      + '    </div>'
